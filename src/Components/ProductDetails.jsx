...
const ProductDetails = ({isProductDetailsOpen, setIsProductDetailsOpen}) => {
    const product = {
        name: "Casual Shoes",
        category: "Sports",
        price: 100,
    ...
    return product && (
        <div className="max-w-6xl w-full px-6" open={isProductDetailsOpen} onclose={() => setIsProductDetailsOpen(false)}>
            <p>
                <span>Home</span> /
                <span> Products</span> /
